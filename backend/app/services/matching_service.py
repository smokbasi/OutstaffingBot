...
def _distance_km_between_stations(
    worker_station: MetroStation | None, job_station: MetroStation | None
) -> float | None:
    ...
    if job_station.lat is None or job_station.lon is None:
        return None
    return geo_service.haversine_km(
        worker_station.lat, worker_station.lon, job_station.lat, job_station.lon
    )
